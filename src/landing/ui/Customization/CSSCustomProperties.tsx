import { type FormEventHandler, forwardRef, Fragment, memo, useCallback } from 'react';
...
const CSSCustomProperties = memo(
  forwardRef<HTMLTextAreaElement, CSSCustomPropertiesProps>(({ onInput, value }, ref) => {
...
CSSCustomProperties.displayName = 'CSSCustomProperties';
