...
import { type FormEventHandler, forwardRef, Fragment, memo, useCallback, useMemo } from 'react';
...
const StyleOptions = memo(
  forwardRef<HTMLTextAreaElement, StyleOptionsProps>(({ onInput, value }, ref) => {
